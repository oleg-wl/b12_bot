...
from telegram.ext import ApplicationBuilder, CommandHandler, TypeHandler, filters
...
def main():
    ...
    unbook_seat_handler = CommandHandler(
        "myseats", ub.check_my_seats, filters=filters.COMMAND
    )
...
if __name__ == "__main__":
    ...
    logger.remove()
    logger.add(sys.stdout, format=fmt, level="TRACE", colorize=True, catch=True)
